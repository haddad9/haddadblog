"""
Django settings for haddadblog project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-qoy25=32)npw42cjz23d6v3hi4-+2g+$a8f$$hq4fuv$7$x%+)')
...
WSGI_APPLICATION = 'haddadblog.wsgi.application'
